...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $target_dir = "FoundUploads/"; // Change this to your desired directory
    $target_file = $target_dir . basename($_FILES['image']['name']);

    // Move uploaded file to the specified directory
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
        $sql = "INSERT INTO `FoundItems` (Name, ID_number, Email, Phone, ItemName, ItemType, ItemColor, Description, Date, Location, Image)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<body>
<h1>Found Item Inquiry Form</h1>
<div class="whole_con">


<div class="para">
        <p>What Have'u Found Today</p>
        <p>let Us Know and let's help Someone</p>
        <p>Find their Essentials</p>
    </div>
    <div class="container" id="mydiv" >
    
        <form action="foundings.php" method="post" enctype="multipart/form-data" style="position:relative;">
            <table>
            <tr>
