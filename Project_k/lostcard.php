...
<div class="card-container">
    <?php
        ...
        $sql = "SELECT ID, Name, ID_Number, ItemType, ItemName, ItemColor, Description, Date, Location,Image,Status FROM LostItems WHERE ID_Number IN (SELECT Username FROM registration WHERE Username = '$username')";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="card" style="position: relative;">
                ...
                <?php endif; ?>
                    ...
                    <button class="status-button <?php echo ($row['Status'] === 'Found') ? 'status-found' : ''; ?>" onclick="changeStatus('<?php echo $id; ?>', this)">
